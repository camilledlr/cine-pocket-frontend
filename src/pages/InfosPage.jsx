...
const InfosPage = () => {
  ...
  return (
    <div>
        ...
        <Input value={director} label="réalisé par" inputId="director" placeholder="un réal visionnaire ou pas..." onChange={(val) => setDirector(val)}/>
        <Input value={actors} label="avec" inputId="actors" placeholder="des acteurs marquants..." onChange={(val) => setActors(val)}/>
        </Form>
        </Modale>
    </div>
  )
