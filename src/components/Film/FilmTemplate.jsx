    ...
    <div>
      <div className="film-header">
        ...
        <div className="film-eval">
          <FilmLiked
            mode={filmInfos.status === "watched" ? "like" : "hype"}
            active={
              filmInfos.status === "watched" ? filmInfos.liked : filmInfos.hyped
            }
            filmId={filmInfos._id}
          />
      ...
      <div className="film-actions">
        ...
        {filmInfos.status === "to_rewatch" && (
          <Tag text="A revoir" size="large" />
        )}
        ...
        <div className="film-action">
          {filmInfos.status !== "to watch" &&
            (filmInfos.shortReview ||
            filmInfos.longReview ||
            filmInfos.rating ? (
              <Button
                ...
                variant="text"
                action={() =>
                  navigate(`/films/review/${filmInfos._id}`, {
                    state: { title: filmInfos.title },
                  })
                }
              />
            ) : (
